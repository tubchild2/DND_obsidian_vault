...
2. Let players die if the context demands it
3. Start every session by painting an immersive picture.
4. Encourage roleplay and "rule of cool" use.
5. Narrate slowly for impactful moments.
...
8. Have NPCs encourage roleplay with questions, and have them do things when the PCs aren't around.
9. Show, don't tell.
