Name: Ratchet Gulliver
Species: Human (Magic Initiate -- Wizard)
...
Background: Sage (Magic Initiate -- Cleric)
...
| Insight         | Wisdom           |             | +5       |
| Medicine        | Wisdom           |             | +5       |
| Perception      | Wisdom           | 1           | +8       |
| Survival        | Wisdom           |             | +5       |
| Arcana          | Intelligence     | 2           | +11      |
| History         | Intelligence     | 1           | +8       |
| Investigation   | Intelligence     | 1           | +8       |
...
---
### [[Serendipita|Ether]]
[[Serendipita|Ether]] Ability: Intelligence
[[Serendipita|Ether]] Modifier: +5
[[Serendipita|Ether]] Save DC: 16
[[Serendipita|Ether]] Attack Bonus: +8
...
| Name            | Type    | Time  | Effect                                                                                                                                                                                                                                                                                                                             |
| --------------- | ------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Produce Flame   | Minder  | Bon   | A harmless flame appears and remains in your hand. Sheds bright light in 10ft radius. Ends if you dismiss it or use it again. You can attack with the flame by making a ranged spin attack on  target within 30ft. On a hit the target takes 1d8 fire damage (avg. 4.5)<br>Damage increases by 1d8 at level 5, lvl 11, and lvl 17. |
| Control Flames  | Minder  | Act   | Choose fire within a 5ft cube that's within 60ft. You can expand it by 5ft in one direction, you can extinguish it, you can double or half the bright light, change its color, or cause simple shapes or animations to appear within the flames.                                                                                   |
| Create Bonfire  | Minder  | Act   | Create a bonfire on ground within 60ft. It fills a 5ft cube. Creatures in the cube must make a dexterity saving throw or take 1d8 fire damage (avg. 4.5). They must repeat this if they enter the space, or end a turn there. <br>Damage increases by 1d8 at lvl 5, lvl 11, and lvl 17.                                            |
| Mending         | Minder  | 1 Min | Instantly repairs a single break or tear in an object you touch. As long as the break or tear is no larger than 1ft, you can mend it, leaving no trace of damage.                                                                                                                                                                  |
| Mage Hand       | Minder  | Act   | Telekinesis with a spectral hand that can't lift anything beyond 5lbs in a 30ft range.                                                                                                                                                                                                                                             |
| Guidance        | Minder  | Act   | Touch a create and choose a skill. They can add 1d4 to any check using that skill for 1 minute.                                                                                                                                                                                                                                    |
| Spare the Dying | Tender  | Act   | Stabilize someone making death saving throws                                                                                                                                                                                                                                                                                       |
| Resistance      | Tender  | Act   | Touch a creature and choose a damage type. They can resist damage by 1d4 of that type for 1 minute.                                                                                                                                                                                                                                |
| Fire Bolt       | Burster | Act   | Range 120ft. Ranged Spin Attack. Target takes 2d10 + 5 fire damage. (Avery allowed me to add by [[Serendipita\|Ether]] modifier)                                                                                                                                                                                                                    |

| Name                      | Type    | Time  | Effect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------- | ------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Shield<br>+FREE USE       | Tender  | React | A reaction when you're hit or targeted. Gives you a +5 AC until the start of your next turn. You become immune to magic missile.                                                                                                                                                                                                                                                                                                                                                                               |
| Cure Wounds<br>+FREE USE  | Tender  | Act   | A creature you touch regains a number of HP equal to 2d8 + your spin ability modifier. The healing increases by 2d8 for each higher level slot used above 1.                                                                                                                                                                                                                                                                                                                                                   |
| Color Spray<br>+ FREE USE | Minder  | Act   | Force CON save on 15ft cone or inflict blindness for 1 turn.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Fog Cloud                 | Minder  | Act   | Creates a 40ft diameter sphere of fog around a point within 120ft. The sphere is heavily obscured, and lasts for an hour or until a strong wind disperses it.                                                                                                                                                                                                                                                                                                                                                  |
| Expeditious Retreat       | Minder  | Bon   | For 10 minutes, the caster gains the ability to dash as a bonus action. This lets you move triple the distance if you use it right.                                                                                                                                                                                                                                                                                                                                                                            |
| Longstrider               | Minder  | Act   | +10 feet movement speed to a creature you touch for 1 hour                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Feather Fall              | Minder  | Reac  | A reaction that's triggered whenever something you see falls. Causes a creature within 60ft to fall at 10fps for 1 minute. No fall damage.                                                                                                                                                                                                                                                                                                                                                                     |
| Entangle                  | Minder  | Act   | A 20ft square within 90ft is covered in grasping plants. They turn the area into difficult terrain, and every creature other than you in the area must make a strength saving throw or be restrained. They can repeat the strength saving throw to escape.                                                                                                                                                                                                                                                     |
| Command                   | Minder  | Act   | Speak a one-word command to a target within 60ft. The target must succeed a wisdom saving throw or follow the command. <br>*Approach.* The target moves towards you on the shortest, most direct path. It ends its turn if its within 5ft.<br>*Drop.* The target drops whatever they're holding and ends its turn.<br>*Flee.* The target spends its entire turn getting as far from you as possible.<br>*Grovel.* The target goes prone and ends its turn.<br>*Halt.* The target does nothing its entire turn. |
| Sanctuary                 | Tender  | Bon   | 30ft range, 1 creature, 1 minute. Anything that attacks the target must succeed a wisdom saving throw or choose a new target. Doesn't work on area effects.                                                                                                                                                                                                                                                                                                                                                    |
| Bless                     | Tender  | Act   | 30ft range, 1 creature, 1 minute. Up to 3 creatures can add a d4 to their attack rolls or saving throws.                                                                                                                                                                                                                                                                                                                                                                                                       |
| Burning Hands             | Burster | Act   | Shoot a sheet of flames out in a 15ft cone. Each creature must make a dexterity saving throw or take 3d6 fire damage (avg. 10.5)                                                                                                                                                                                                                                                                                                                                                                               |
| Chromatic Orb             | Burster | Act   | 90ft range. Ranged spell attack that deals 3d8 damage of one of these types of your choice: acid, cold, fire, lightning, poison, or thunder.                                                                                                                                                                                                                                                                                                                                                                   |
| Magic Missile             | Buster  | Act   | 120ft Range. 3 darts that each deal 1d4 + 1 force damage and always hit.                                                                                                                                                                                                                                                                                                                                                                                                                                       |

| Name                       | Type    | Time | Effect                                                                                                                                                                                                                                                                                               |
| -------------------------- | ------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Misty Step                 | Minder  | Bon  | Teleport 30ft to an unoccupied space you can see                                                                                                                                                                                                                                                     |
| Enlarge / Reduce           | Minder  | Act  | Range 30ft. Increases / decreases object or creature size by one category. Objects change size with creature.<br>Enlarged creatures have advantage on STR checks and throws, and they deal +1d4 damage.<br>Reduced creatures have disadvantage on STR checks and throws, and they deals -1d4 damage. |
| Hold Person                | Minder  | Act  | Range 60ft. Lasts up to a minute. Choose a humanoid in range. They must succeed a WIS throw each turn or be paralyzed. While paralyzed, attacks have advantage and are attacks from within 5ft are always critical hits.                                                                             |
| Invisibility<br>+ FREE USE | Minder  | Act  | Touch a creature. They become invisible for up to an hour. Invisibility ends when you make an attack roll, deal damage, or cast a spin.                                                                                                                                                              |
| Scorching Ray              | Burster | Act  | 120ft Range. Target takes 6d6 Fire damage, or 3 targets each take 2d6 Fire damage                                                                                                                                                                                                                    |
...
RATCHET'S DOOMSDAY DEVICE
- 122 Smokepowder bombs mended together and placed inside the Confiscated Quantum Cram Pack
- 625ft radius (1250ft diameter) detonation that breaks and ignites objects in vicinity
- Inflicts 366d4 + 1098 force damage
- Ideas
	- Bird Bomber
	- Tripwire Trap
...
Magical Tinkering. 
- I can make a tiny nonmagical item do some random stuff that's almost exclusively helpful in roleplay. I can make lights, odors, text, audio recordings, etc. 

Primitive Infusion. 
- A homebrew artificer ability in which I can create a primitive piece of [[Serendipita|E-Tech]] that can perform a cantrip once before falling apart. Takes a long or short rest.

Arcane Recovery.
- After a short rest, regain expended spell slots with a combined total no more than half of your wizard level (round up).

Shadow Touched.
- Free use of Color Spray and Invisibility per Long Rest.

Scholar. 
- Expert Arcana.

Evocation Savant.
- Whenever you acquire Evocation spins, add one more to your list. You need to have slots for it. 

Potent Cantrip
- If you miss with your attack roll, or the target succeeds a save, they still take half the cantrip's damage, but suffer no additional effects.

Smokepowder Bombs. 
- Bombs have a range of 30ft (?) and explode in a 15ft radius. They inflict 3d4 + 9 force damage. Can be used to break or ignite objects. Creatures in the blast that succeed a DC15 DEX save take half damage.
