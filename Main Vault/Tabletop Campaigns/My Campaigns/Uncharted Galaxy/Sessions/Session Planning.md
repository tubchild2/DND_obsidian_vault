...
- The [[Armstrong Initiative]] and the [[Tessali]] nature / history with them. Reveal [[Ether C1|Ether]].
...
- Reveal of the [[Primordials C1|Primordials]]. Reveal that [[Bradford]] has an arrangement with a [[Primordials C1|primordial]], but he doesn't know that's what it is. 
...
- Wish-[[Ether Users C1|magic]] based on player sketches.
...
- Triple illithid empires that wiped each other out. They have knowledge of the [[Primordials C1|primordials]], but only exist in tiny fractions in modern times. 
### NPCs:
