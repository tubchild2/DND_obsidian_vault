...
- **Fantastical (>50%).** A realm with medium enforcement. A mostly realistic universe with some [[Ether C1]]. The rules are flexible, but nonetheless firmly in-place. 
...
- **Abstract (>0%).** A realm with no enforcement. There are no laws of physics, as the realm is made of ideas represented by [[Ether C1]]. A realm of pure creation. 
### The Barrier
...
- **Tension.** A measurement of how much power (be it physical or abstract) it requires to puncture the barrier and create a [[Portals C1|gateway]].
- **Durability.** A measurement of how much damage the barrier can sustain before breaking. If the barrier receives too much damage, the individual [[Portals C1]] will begin to grow and rip open. If left unchecked, they'll shatter the barrier entirely.  Breaking the barrier causes the cataclysm (see "The Cataclysm"). 
### The Cataclysm
...
### Key Items
Some items of immense abstract or physical power can become resistant to the cataclysm, allowing them to exist in all subsequent cycles. The only items capable of doing this are ones of either extreme [[Ether C1|Ether]] concentration, or extreme energy conservation.
