...
**Summary**
Help your audience to follow along with your talk, and make clear how each main point relates to your objective and theme.


**Have an Objective**
Consider whether your talk is intended to inform, convince, or motivate your audience, and then develop it accordingly. Make sure all main points help you to achieve your objective.
...
Select only main points that relate to your theme and that you can teach effectively in the allotted time. Limit the number of main points, clearly state each main point, pause between them, and lead smoothly from one main point to the next.
...
**Why We Remain Politically Neutral**
- Overview
- Is this a modern innovation?


**Our Attitude Towards Governments**
- Respect for governments
- Is our political neutrality a threat to national security?
