...
Points
- Preview article or the chapter
	- Think about the title
	- Think about how the subheadings relate to the theme
	- Think about any illustrations or charts
	- What do I expect to learn
- Get the facts
	- As you go through the article, mark answers to questions
	- Mark points you want to remember
	- Think about points you could use in the ministry
	- Think about points you could share with people
	- Look up cited scriptures and think about how they relate
- Handle obstacles with additional research
	- Make a note to give something further consideration later if you can't understand it right now
	- If the point isn't clarified later, you can do additional research
- Get the main points and act on them
	- Paul did this
	- Use them to discern the development of the theme to impress them on our minds so we can actually use them and act in harmony with them
	- Think about how you can apply it!
- Review
	- See if you can recall the main points and supporting arguments
	- Doing this will help you to retain it


### Talk Outline
- Introduction
	- Hook
		- Have you ever studied and forgotten about it an hour later? I know I have.
		- Something about attention spans getting shorter making it harder to focus and actually get good spiritual gems. This talk will fix that by giving some easy ways to get more out of your study. 
	- Emphasize theme of the talk
		- This talk is entitled how to study, but a more accurate title would be how to get the most of studying
	- Show why the subject matters
		- It's important to learn how to find spiritual gems, even if they aren't much, because they'll stick in your mind better and help you to apply them
	- Make main points clear and simple
		- There's 4 steps we're going to talk about that should quickly and easily let you get more out of your studies
			- Preview
			- Synonym for Write Down or Mark or Highlight or Something
			- Review
			- Apply
- Preview
