...
The Werewolf Session Recipe:
- Something goes wrong and it seems like one of the players did it
- Desperation and panic are important. They need to figure it out but they don't have time and the consequence for failure feels huge.
	- Secrets were a good start to instilling panic. I think that if they had some other reason to want attention off of themselves it would've worked better
	- Additionally, shame itself wasn't bad enough; they need consequences to be scared. They need to be BIG if this is going to work as a concept.
	- GM created secrets would've worked better. I'd have them happen organically over time and then build them up.
- Players feel like they have little control, and that their best bet is accusation and deduction
- The crime has to not only be possible to have been committed by a player, but to feel like a crime committed by a player. That means it's sloppy, non-specific, improvised, and riddled with weird details and mistakes.
	- The separation aspect greatly helped to make it seem possible, but the perfect crime wasn't believable from a player.
- They need to be willing to turn on each other. 
	- Being a close family may make the betrayal hit harder, but the accusation and elimination aspect is what's important, not the shock from the betrayal.
	- They need reasons to distrust each other.
	- Competition, differing objectives, limited resources
- They need a tangible way to make progress without actually finding the person
	- Create a mystery web that would take far too long to solve.
	- Create an unsolvable mystery.
	- Create a bunch of good clues to stir the pot that aren't conclusive evidence.
- Playtest! Get feedback! Honest criticism is incredibly important for catching things that aren't believable!
- Give yourself an out in case they figure it out.
	- Don't tie it to actual media so they can't guess possible endings or solutions
