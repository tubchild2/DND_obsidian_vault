...
| Fire Bolt       | Burster | Act   | Range 120ft. Ranged Spin Attack. Target takes 2d10 + 5 fire damage. (Avery allowed me to add by Ether modifier)                                                                                                                                                                                                                    |
...
- Ideas
	- Carry people in it
	- Detonate bomb in it and direct explosion
	- Put one pocket into another to create a portal
		- Banish a creature
		- Create Eathyst
		- Power E-Tech
		- Detonate Eathyst
...
- 80x Smokepowder bombs mended together and placed inside the Confiscated Quantum Cram Pack
	- 8 short rests a day + 1 regular long rest = 10 bombs a day for 7 days + 10 starter bombs = 80
- 410ft radius (820ft diameter) detonation that breaks and ignites objects in vicinity
- Inflicts 240d4 + 720 force damage
- Ideas
	- Bird Bomber
	- Tripwire Trap
	- Remote Detonation with Fire Bolt
...
Primitive Infusion. 
- A homebrew artificer ability in which I can create a primitive piece of E-Tech that can perform a cantrip once before falling apart. Takes a long or short rest.
